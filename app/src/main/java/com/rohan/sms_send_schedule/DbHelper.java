...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void save(com.rohan.sms_send_schedule.SmsModel sms) {
    ...
    public com.rohan.sms_send_schedule.SmsModel get(long timestampCreated) {
        ...
        if (cursor != null) {
            ArrayList<com.rohan.sms_send_schedule.SmsModel> results = getObjects(cursor);
            cursor.close();
            if (results.size() > 0) {
    ...
    public ArrayList<com.rohan.sms_send_schedule.SmsModel> get(String status) {
    ...
    private ArrayList<com.rohan.sms_send_schedule.SmsModel> getObjects(Cursor cursor) {
        ArrayList<com.rohan.sms_send_schedule.SmsModel> result = new ArrayList<>();
        ...
        com.rohan.sms_send_schedule.SmsModel object;
        while (cursor.moveToNext()) {
            object = new com.rohan.sms_send_schedule.SmsModel();
